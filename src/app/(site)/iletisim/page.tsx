...
export const metadata: Metadata = {
  title: "İletişim",
  description: "LAZOĞLU KURUYEMİŞ ile iletişime geçin. Perakende siparişleriniz veya toptan satış talepleriniz için bize ulaşın. 0541 649 08 83",
};
      ...
      <div className="container-main py-12 sm:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-10">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <a
              href="https://maps.google.com/?q=Ulukavak+Mahallesi+Sel%C3%A7uk+Cd+No18B+%C3%87orum"
              target="_blank"
              rel="noopener noreferrer"
            ...
            >
              ...
              <div>
                ...
                <p className="font-bold text-gray-900 leading-snug">Ulukavak Mah. Selçuk Cd. No:18/B</p>
                <p className="text-gray-700 font-medium">19040 Çorum Merkez / Çorum</p>
              </div>
            </a>
            <a
            ...
            <div className="p-4 rounded-2xl text-center border border-brand-100 bg-white">
              <p className="text-brand-700 font-bold text-sm">LAZOĞLU KURUYEMİŞ</p>
