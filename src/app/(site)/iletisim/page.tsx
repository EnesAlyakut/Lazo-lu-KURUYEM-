...
export const metadata: Metadata = {
  title: "İletişim",
  description: "FK Kuruyemiş ile iletişime geçin. Perakende siparişleriniz veya toptan satış talepleriniz için bize ulaşın. 0505 889 88 28",
};
...
export default function IletisimPage() {
  return (
    ...
    >
      {/* Hero Banner */}
      <div className="bg-gradient-to-r from-brand-600 to-brand-500 py-14">
        <div className="container-main text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white font-display mb-4 drop-shadow-sm">
            İletişim
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <a
              ...
              className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-brand-100 shadow-sm hover:shadow-warm hover:-translate-y-0.5 transition-all duration-200 group"
            >
              ...
              <div>
                ...
                <p className="text-lg font-bold text-gray-900">0 (505) 889 88 28</p>
                <p className="text-sm text-gray-500">Hafta içi ve Cumartesi: 09:00 – 20:00</p>
              </div>
            </a>

            <a
              href="https://wa.me/905058898828"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-green-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 group"
            >
            ...
            <a
              href="https://maps.google.com/?q=Çöplü+Mahallesi+Camikebir+3.+Sokak+Merkez+Çorum"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-purple-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 group"
            >
              ...
              <div>
                ...
                <p className="font-bold text-gray-900 leading-snug">Çöplü Mah. Camikebir 3. Sokak</p>
                <p className="text-gray-700 font-medium">Merkez / Çorum</p>
              </div>
            </a>

            <a
              href="mailto:info@fkkuruyemis.com"
              className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-sky-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 group"
            >
              ...
              <div>
                ...
                <p className="font-bold text-gray-900">info@fkkuruyemis.com</p>
              </div>
            </a>

            <div className="flex items-center gap-4 p-5 bg-white rounded-2xl border border-amber-100 shadow-sm">
            ...
            <div className="p-4 rounded-2xl text-center border border-brand-100 bg-white">
              <p className="text-brand-700 font-bold text-sm">🌰 FK Kuruyemiş</p>
              <p className="text-brand-600 text-xs mt-1">Tazeliğin ve Geleneksel Lezzetin Çorum&apos;daki Adresi</p>
            </div>
          </div>

          {/* Mesaj Formu */}
          <div className="lg:col-span-3 bg-white rounded-3xl border border-brand-100 shadow-warm p-8 md:p-10">
