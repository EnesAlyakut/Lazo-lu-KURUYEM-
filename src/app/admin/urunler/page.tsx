        ...
        <div className="divide-y divide-gray-100">
          {normalizedProducts.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="grid grid-cols-1 gap-4 p-4 transition-colors hover:bg-gray-50 xl:grid-cols-[minmax(320px,1.4fr)_180px_150px_110px_190px_88px] xl:items-center"
              >
                ...
                <div>
                  <p className="text-xs font-semibold uppercase tracking-wide text-gray-400 xl:hidden">
                    Kategori
                  </p>
                ...
                <div>
                  ...
                  {cheapestVariant && (
                    <p className="mt-0.5 text-xs text-gray-400">
                      En düşük: {formatPrice(cheapestVariant.price)} ₺
                    </p>
                  )}
                </div>
                ...
                <div className="flex items-center gap-2 xl:justify-end">
                  <Link
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-lg text-blue-500 transition-colors hover:bg-blue-50"
                    title="Düzenle"
                  >
                    <Edit size={15} />
                  </Link>
